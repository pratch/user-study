...
base_path="final_cropped_rotated_liveport"
labelled_path="labeled_videos_liveport"
out_path="final_videos_concat_liveport"
...
for subject in "${subjects[@]}"; do
    for sen in "A" "B"; do
        ...
        ours_name="${ours_method}_liveport_${sen}_${subject}"
        ...
        for competing_method in "${competing_methods[@]}"; do
            ...
            competing_name="${competing_method}_liveport_${sen}_${subject}_rotated"
